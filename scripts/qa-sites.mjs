    ...
    for (const [index, business] of businesses.entries()) {
      ...
      const evidence = await page.evaluate(({ expectedName, mobileContact }) => {
        ...
        return {
          ...
          ownerPhotoBriefs: document.querySelectorAll(".photo-brief").length >= 2,
          conceptImages: document.querySelectorAll(".photo-gallery img").length >= 1,
          researchLabels: document.querySelectorAll(".business-ribbon small").length >= 3,
